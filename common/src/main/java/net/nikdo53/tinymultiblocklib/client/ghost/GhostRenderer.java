...
public abstract class GhostRenderer<T extends GhostRenderer<T>> {
    ...
    protected void prepareAndRender(float partialTick, CameraRenderState camera, ClientLevel level, PoseStack poseStack, MultiBufferSource.BufferSource buffer){
