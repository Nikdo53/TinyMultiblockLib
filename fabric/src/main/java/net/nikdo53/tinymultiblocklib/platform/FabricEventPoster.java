...
import com.mojang.blaze3d.vertex.PoseStack;import net.minecraft.client.renderer.MultiBufferSource;
...
public class FabricEventPoster implements IEventPoster {
    ...
    public IOnBlockPreviewEvent onBlockPreviewPre(PreviewMode previewMode, boolean isCancelled, BlockLive center, Set<BlockLive> blockLiveSet) {
        return OnBlockPreviewEvent.PreEvent.EVENT.invoker().onBlockPreview(new OnBlockPreviewEvent.Pre(previewMode, isCancelled, center, blockLiveSet));
    }
    ...
    public void onBlockPreviewPost(PreviewMode previewMode, BlockLive center, Set<BlockLive> blockLiveSet, PoseStack poseStack, float partialTicks, MultiBufferSource.BufferSource bufferSource) {
        OnBlockPreviewEvent.PostEvent.EVENT.invoker().postBlockPreview(new OnBlockPreviewEvent.Post(previewMode, center, blockLiveSet, poseStack, partialTicks, bufferSource));
    }
