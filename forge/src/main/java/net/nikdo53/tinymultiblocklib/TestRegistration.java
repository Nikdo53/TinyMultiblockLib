...
public class TestRegistration {
    public static void register(IEventBus modEventBus) {
        ...
        MinecraftForge.EVENT_BUS.addListener(TestRegistration::testRightClickEvent);
    }
    ...
    public static void testRightClickEvent(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (blockPatternMatch != null) {
            ...
            level.setBlock(center, CommonRegistration.Blocks.DIAMOND_STRUCTURE_BLOCK.get().defaultBlockState().setValue(AbstractMultiBlock.CENTER, true), 3);
        }
    }
}
